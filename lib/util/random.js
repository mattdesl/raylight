const defaultSeed = String(Math.floor(Math.random() * 100000));
...
module.exports.nextSeed = () => {
  ...
  module.exports.random = seedRandom(currentSeed, { global: true });
  module.exports.simplex = new SimplexNoise(module.exports.random);
};

module.exports.getSeed = () => currentSeed;
...
module.exports.randomSphere = function (out, scale, u = module.exports.random(), v = module.exports.random()) {
  scale = scale || 1.0;
  var r = u * 2.0 * Math.PI;
  var z = (v * 2.0) - 1.0;
