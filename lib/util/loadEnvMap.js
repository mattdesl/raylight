...
module.exports = function loadEnvMap (opt = {}, cb = noop) {
  ...
  const onCubeMapLoaded = (tex) => {
    console.log("HELLO", tex)
    const cubeMap = module.exports.filterCubeMap(renderer, tex, opt)
    cb(null, cubeMap);
    cb = noop;
  };
...
module.exports.filterCubeMap = function filterCubeMap (renderer, cubeMap, opt = {}) {
